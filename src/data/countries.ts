...
export const countries: Country[] = [
  ...
  { name: "Spain", code: "es", capital: "Madrid", lat: 40.4637, lon: -3.7492, continent: "Europe", nativeName: "España", funFacts: ["Spain has the second-highest number of UNESCO World Heritage sites.", "Spanish is the world's second-most spoken native language.", "La Sagrada Família in Barcelona has been under construction for over 140 years."], description: "Spain occupies most of the Iberian Peninsula in southwestern Europe. It is known for flamenco, football, and a mix of Mediterranean and Atlantic culture.", history: "Spain was unified under the Catholic Monarchs in the late 15th century. It built a vast overseas empire. The country became a democracy after Franco's rule ended in 1975." },
